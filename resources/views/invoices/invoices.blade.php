                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="restoreModalLabel">تأكيد الأرشفة</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <form
                                                            action="{{ route('archiveController.update', $invoice->id) }}"
                                                            method="POST">
                                                            @method('PUT')
                                                            {{ csrf_field() }}
                                                            <div class="form-group">
                                                                <p>هل انت متأكد من أرشفة الفاتورة؟</p>
                                                            </div>
