...
@section('content')
    ...
    <div class="row">
        ...
        @if (session()->has('unarchive'))
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong>{{ session()->get('unarchive') }}</strong>
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($invoices as $invoice)
                                    <tr>
                                        ...
                                        <td>
                                            <a
                                                href="{{ route('details.show', $invoice->id) }}">{{ $invoice->invoice_number }}</a>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a href="{{ route('archiveController.destroy', $invoice->id) }}"
                                    ...
                                    <div class="modal fade" id="restoreModal" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="restoreModalLabel">تأكيد النقل من الأرشيف
                                                    </h5>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('archiveController.destroy', $invoice->id) }}"
                                                        method="POST">
                                                        @method('DELETE')
                                                        {{ csrf_field() }}
                                                        <div class="form-group">
                                                            <p>هل انت متأكد من نقل الفاتورة من الأرشيف؟</p>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary"
                                                                data-dismiss="modal">إلغاء</button>
