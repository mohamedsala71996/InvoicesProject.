                        ...
                        <a class="new nav-link" href="#">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										...
										<a href="{{route("markAsRead")}}">	<span class="badge badge-pill badge-warning mr-auto my-auto float-left">جعل الكل مقروء</span></a>
										</div>
									...
									<div class="main-notification-list Notification-scroll">
										<a class="d-flex p-3 border-bottom" href="{{url("markAsOneRead/{$notification->id}/{$notification->data["invoice_id"]}")}}">
										  <div class="notifyimg bg-pink">
											<i class="la la-file-alt text-white"></i>
										  </div>
										  <div class="mr-3">
											<h5 class="notification-label mb-1">Invoice Number: {{$notification->data["invoice_number"]}}</h5>
											<div class="notification-subtext">Created at: {{$notification->created_at}}</div>
											<div class="notification-subtext">By: {{$notification->data["user_name"]}}</div>
										  </div>
										</a>
									  </div>								
									@endforeach
