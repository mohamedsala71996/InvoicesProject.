...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('details.update', $invoices->id) }}" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                        {{ csrf_field() }}
                        {{-- 1 --}}
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" readonly value="{{ $invoices->invoice_number }}"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select disabled name="Section" class="form-control SlectBox"
                                    ...
                                    <!--placeholder-->
                                    {{-- <option value="{{ $invoices->sections_id }}" selected disabled> {{ $invoices->sections->section_name }}</option> --}}
                                    @foreach ($sections as $section)
                                        <option @if ($section->id == $invoices->sections_id) {{ 'selected' }} @endif
                            ...
                            <div class="col">
                                ...
                                <input type="text" readonly class="form-control" id="inputName"
                                    value="{{ $invoices->Amount_collection }}" name="Amount_collection"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" readonly class="form-control form-control-lg"
                                    value="{{ $invoices->Amount_Commission }}" id="Amount_Commission"
                            ...
                            <div class="col">
                                ...
                                <input type="text" readonly class="form-control form-control-lg"
                                    value="{{ $invoices->discount }}" id="Discount" name="Discount"
                            ...
                            <div class="col">
                                ...
                                <select disabled name="Rate_VAT" id="Rate_VAT" class="form-control"
                                    ...
                                    <option @if ($invoices->tax_rate == '5%') {{ 'selected' }} @endif value=" 5%">5%
                                    </option>

                                    <option @if ($invoices->tax_rate == '10%') {{ 'selected' }} @endif value="10%">
                                        10%</option>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" readonly class="form-control" id="Value_VAT"
                                    value="{{ $invoices->tax_value }}" name="Value_VAT" readonly>
                            </div>

                            <div class="col">
                                <label for="inputName" class="control-label">الاجمالي شامل الضريبة</label>
                                <input type="text" readonly class="form-control" value="{{ $invoices->Total }}"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" readonly id="exampleTextarea" name="note" value="{{ $invoices->note }}"
                                    rows="3"></textarea>
                            </div>
                        </div><br>
                        <div class="row">
                            <div class="col">
                                ...
                                <select id="value_status" name="value_status" class="form-control">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" 
                                    name="Payment_Date" placeholder="YYYY-MM-DD" type="text" required>
