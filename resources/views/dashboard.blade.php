...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
							<h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">أهلا بك في برنامج الفواتير!</h2>
						</div>
					</div>
				</div>
				<!-- /breadcrumb -->
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											...
											@php
											$x=	App\Models\invoices::count();
											@endphp
											@if($x==0)
											<span class="text-white op-7">{{0}}</span>
											@else
											<span class="text-white op-7">{{round(App\Models\invoices::where("value_status",1)->count()/$x*100)}}</span>
										</span>
											@endif
									</div>
								</div>
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">{{0}}</span>
											@else
											<span class="text-white op-7">{{round(App\Models\invoices::where("value_status",2)->count()/$x*100)}}</span>
										</span>
											@endif
									</div>
								</div>
						...
						<div class="card overflow-hidden sales-card bg-warning-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{number_format(App\Models\invoices::where("value_status",2)->sum("Total"),3)}}</h4>
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">{{0}}</span>
											@else
											<span class="text-white op-7">{{round(App\Models\invoices::where("value_status",3)->count()/$x*100)}}</span>
										</span>
											@endif
									</div>
								</div>
				...
				<div class="row row-sm">
					...
					<div class="col-lg-12 col-xl-5">
						<div class="card card-dashboard-map-one">
							<label class="main-content-label">اجمالي الفواتير</label>
							<div class="">
