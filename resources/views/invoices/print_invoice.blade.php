                            ...
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="tx-right">معدل الضريبة</th>
                                        <th class="tx-right">قيمة الضريبة</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="tx-right">{{number_format($invoices->Amount_collection,2)}}</td>
                                        <td class="tx-right">{{number_format($invoices->Amount_Commission,2)}}</td>
                                        <td class="tx-right">{{number_format($invoices->discount,2)}}</td>
                                        <td class="tx-right">{{$invoices->tax_rate}}</td>
                                        <td class="tx-right">{{number_format($invoices->tax_value,2)}}</td>
                                        <td class="tx-right">{{number_format($invoices->Total,2)}}</td>
                                        <td class="tx-right">{{$invoices->Status}}</td>
                                        <td class="tx-right">{{$invoices->note}}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
